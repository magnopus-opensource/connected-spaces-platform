 ...
 */
CLIArgs::RunnerSettings ValidateInvocationArgs(const std::string& TestIdentifier,
											   std::optional<std::string> LoginEmail,
											   std::optional<std::string> LoginPassword,
											   const std::optional<std::string>& Endpoint,
											   const std::optional<std::string>& SpaceId,
