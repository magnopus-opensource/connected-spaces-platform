	...
	SpaceSystem.EnterSpace(SpaceId.c_str(),
						   [&ResultPromise](csp::systems::NullResult Result)
						   {
							   ...
							   if (Result.GetResultCode() == csp::systems::EResultCode::Success
								   || Result.GetResultCode() == csp::systems::EResultCode::Failed)
							   {
...
std::string SpaceRAII::GetSpaceId()
{
	return SpaceId;
}
...
csp::systems::Space SpaceRAII::CreateDefaultTestSpace(csp::systems::SpaceSystem& SpaceSystem)
{
	...
	SpaceSystem.CreateSpace(UniqueSpaceName.c_str(),
							TestSpaceDescription,
							csp::systems::SpaceAttributes::Private,
							nullptr,
							csp::common::Map<csp::common::String, csp::common::String> {{"site", "Void"}},
							nullptr,
							nullptr,
