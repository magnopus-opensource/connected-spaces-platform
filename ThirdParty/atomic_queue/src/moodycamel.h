...
template <class T, unsigned Capacity> struct MoodyCamelQueue : moodycamel::ConcurrentQueue<T>
{
	...
	MoodyCamelQueue(Context context) : moodycamel::ConcurrentQueue<T>(Capacity, context.producers, 0)
	{
	}
...
template <class T, unsigned Capacity> struct MoodyCamelReaderWriterQueue : moodycamel::ReaderWriterQueue<T>
{
	MoodyCamelReaderWriterQueue() : moodycamel::ReaderWriterQueue<T>(Capacity)
	{
	}
