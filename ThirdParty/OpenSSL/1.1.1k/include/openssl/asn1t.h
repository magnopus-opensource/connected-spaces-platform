...
#define static_ASN1_ITEM_TEMPLATE_END(tname) \
	;                                        \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_PRIMITIVE, -1, &tname##_item_tt, 0, NULL, 0, #tname ASN1_ITEM_end(tname)
...
#define ASN1_SEQUENCE_END_name(stname, tname)                                                                                          \
	;                                                                                                                                  \
	ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL, \
		sizeof(stname), #tname ASN1_ITEM_end(tname)

#define static_ASN1_SEQUENCE_END_name(stname, tname)                                                                                          \
	;                                                                                                                                         \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL, \
...
#define ASN1_NDEF_SEQUENCE_END(tname)                                                                                                       \
	;                                                                                                                                       \
	ASN1_ITEM_start(tname) ASN1_ITYPE_NDEF_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL, \
		sizeof(tname), #tname ASN1_ITEM_end(tname)
#define static_ASN1_NDEF_SEQUENCE_END(tname)                                                                                                       \
	;                                                                                                                                              \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_NDEF_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL, \
		sizeof(tname), #tname ASN1_ITEM_end(tname)
...
#define ASN1_SEQUENCE_END_ref(stname, tname)                                                                                                   \
	;                                                                                                                                          \
	ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), &tname##_aux, \
		sizeof(stname), #tname ASN1_ITEM_end(tname)
#define static_ASN1_SEQUENCE_END_ref(stname, tname)                                                                                     \
	;                                                                                                                                   \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), \
		&tname##_aux, sizeof(stname), #stname ASN1_ITEM_end(tname)

#define ASN1_NDEF_SEQUENCE_END_cb(stname, tname)                                                                                                    \
	;                                                                                                                                               \
	ASN1_ITEM_start(tname) ASN1_ITYPE_NDEF_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), &tname##_aux, \
		sizeof(stname), #stname ASN1_ITEM_end(tname)
...
#define ASN1_CHOICE_END_selector(stname, tname, selname)                                                                                     \
	;                                                                                                                                        \
	ASN1_ITEM_start(tname) ASN1_ITYPE_CHOICE, offsetof(stname, selname), tname##_ch_tt, sizeof(tname##_ch_tt) / sizeof(ASN1_TEMPLATE), NULL, \
		sizeof(stname), #stname ASN1_ITEM_end(tname)

#define static_ASN1_CHOICE_END_selector(stname, tname, selname)                                                                                     \
	;                                                                                                                                               \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_CHOICE, offsetof(stname, selname), tname##_ch_tt, sizeof(tname##_ch_tt) / sizeof(ASN1_TEMPLATE), NULL, \
		sizeof(stname), #stname ASN1_ITEM_end(tname)

#define ASN1_CHOICE_END_cb(stname, tname, selname)                                                                                                   \
	;                                                                                                                                                \
	ASN1_ITEM_start(tname) ASN1_ITYPE_CHOICE, offsetof(stname, selname), tname##_ch_tt, sizeof(tname##_ch_tt) / sizeof(ASN1_TEMPLATE), &tname##_aux, \
		sizeof(stname), #stname ASN1_ITEM_end(tname)
...
#define ASN1_ADB(name) static const ASN1_ADB_TABLE name##_adbtbl[]
	...
	#define ASN1_ADB_END(name, flags, field, adb_cb, def, none) \
		...
		static const ASN1_ADB name##_adb                        \
			= {flags, offsetof(name, field), adb_cb, name##_adbtbl, sizeof(name##_adbtbl) / sizeof(ASN1_ADB_TABLE), def, none}
