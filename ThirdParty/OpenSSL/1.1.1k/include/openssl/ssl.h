...
#define SSL_FILETYPE_PEM  X509_FILETYPE_PEM
	...
	typedef int (
		*tls_session_secret_cb_fn)(SSL *s, void *secret, int *secret_len, STACK_OF(SSL_CIPHER) * peer_ciphers, const SSL_CIPHER **cipher, void *arg);
...
#define SSL_EXT_TLS1_3_CERTIFICATE_REQUEST	0x4000
	...
	typedef int (*SSL_custom_ext_add_cb_ex)(SSL *s,
	...
	typedef int (*SSL_custom_ext_parse_cb_ex)(SSL *s,
											  unsigned int ext_type,
											  unsigned int context,
 ...
 */
#define SSL_OP_ALL                                                                                                           \
	(SSL_OP_CRYPTOPRO_TLSEXT_BUG | SSL_OP_DONT_INSERT_EMPTY_FRAGMENTS | SSL_OP_LEGACY_SERVER_CONNECT | SSL_OP_TLSEXT_PADDING \
...
#define SSL_CTX_sess_cache_full(ctx)		  SSL_CTX_ctrl(ctx, SSL_CTRL_SESS_CACHE_FULL, 0, NULL)
	...
	typedef int (
		*SSL_CTX_npn_select_cb_func)(SSL *s, unsigned char **out, unsigned char *outlen, const unsigned char *in, unsigned int inlen, void *arg);
