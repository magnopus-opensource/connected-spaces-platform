...
#define OBJ_bsearch(type1, key, type2, base, num, cmp)   \
	((type2 *) OBJ_bsearch_(CHECKED_PTR_OF(type1, key),  \
							...
							num,                         \
							sizeof(type2),               \
							((void) CHECKED_PTR_OF(type1, cmp##_type_1), (void) CHECKED_PTR_OF(type2, cmp##_type_2), cmp##_BSEARCH_CMP_FN)))
...
#define OBJ_bsearch_ex(type1, key, type2, base, num, cmp, flags)                                                                   \
	((type2 *) OBJ_bsearch_ex_(                                                                                                    \
		 ...
		 num,                                                                                                                      \
		 sizeof(type2),                                                                                                            \
		 ((void) CHECKED_PTR_OF(type1, cmp##_type_1), (void) type_2 = CHECKED_PTR_OF(type2, cmp##_type_2), cmp##_BSEARCH_CMP_FN)), \
	 flags)
