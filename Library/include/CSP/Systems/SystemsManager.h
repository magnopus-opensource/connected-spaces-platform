...
public:
    ...
    csp::multiplayer::OfflineRealtimeEngine* MakeOfflineRealtimeEngine();
    csp::common::IRealtimeEngine* MakeRealtimeEngine(csp::common::RealtimeEngineType RealtimeEngineType);
