...
public:
	...
	CSP_ASYNC_RESULT void CreateAnchor(csp::systems::AnchorProvider ThirdPartyAnchorProvider,
	...
	CSP_ASYNC_RESULT void
		CreateAnchorInSpace(csp::systems::AnchorProvider ThirdPartyAnchorProvider,
							const csp::common::String& ThirdPartyAnchorId,
	...
	CSP_ASYNC_RESULT void GetAnchorsInArea(const csp::systems::GeoLocation& OriginLocation,
	...
	/// @param Limit int : optional Maximum number of result entries to be retrieved. for all available result entries pass
	/// @param Callback AnchorCollectionResultCallback : callback when asynchronous task finishes
	CSP_ASYNC_RESULT void GetAnchorsInSpace(const csp::common::String& SpaceId,
											const csp::common::Optional<int>& Skip,
											const csp::common::Optional<int>& Limit,
											AnchorCollectionResultCallback Callback);
	...
	/// @param Callback AnchorCollectionResultCallback : callback when asynchronous task finishes
	CSP_ASYNC_RESULT void GetAnchorsByAssetCollectionId(const csp::common::String& AssetCollectionId,
														const csp::common::Optional<int>& Skip,
														const csp::common::Optional<int>& Limit,
														AnchorCollectionResultCallback Callback);
	...
	CSP_ASYNC_RESULT void CreateAnchorResolution(const csp::common::String& AnchorId,
