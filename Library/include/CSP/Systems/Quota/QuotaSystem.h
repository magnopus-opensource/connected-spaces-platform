...
private:
    ...
    csp::services::ApiBase* m_quotaTierAssignmentApi;
    csp::services::ApiBase* m_quotaManagementApi;
    csp::services::ApiBase* m_quotaActivityApi;

    const csp::common::IAuthContext* m_context;
};
} // namespace csp::systems
