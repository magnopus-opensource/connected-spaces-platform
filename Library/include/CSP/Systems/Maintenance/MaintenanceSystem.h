...
public:
	...
	/// @param Callback BooleanResultCallback : callback when asynchronous task finishes
	CSP_ASYNC_RESULT void IsInsideMaintenanceWindow(BooleanResultCallback Callback);
