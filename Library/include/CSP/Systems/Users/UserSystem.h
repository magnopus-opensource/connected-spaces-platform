...
public:
    ...
    typedef std::function<void(const csp::multiplayer::AccessControlChangedEventData&)> UserPermissionsChangedCallbackHandler;
    ...
    CSP_NO_EXPORT void OnAccessControlChangedEvent(const csp::multiplayer::EventData& EventData);
