...
/// @ingroup Space System
/// @brief Data class used to contain the obfuscated email addresses of the users that have accepted the space invites
...
public:
    /// @brief Retrieves the stored obfuscated email addresses
    /// @return csp::common::Array<csp::common::String> : reference to the emails array
    csp::common::Array<csp::common::String>& GetAcceptedInvitesEmails();

    /// @brief Retrieves the stored obfuscated email addresses
    /// @return csp::common::Array<csp::common::String> : reference to the emails array
    const csp::common::Array<csp::common::String>& GetAcceptedInvitesEmails() const;
...
private:
    ...
    csp::common::Array<csp::common::String> AcceptedInvitesEmailAddresses;
};
