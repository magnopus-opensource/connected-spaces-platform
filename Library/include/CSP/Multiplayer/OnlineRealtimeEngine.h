...
public:
    ...
    typedef std::function<void(const csp::common::String& ScopeId, const csp::common::String& UserId /*, uint64_t ClientId*/)> ScopeLeaderCallback;
    ...
    CSP_NO_EXPORT void __AssumeScopeLeadership(const std::string& ScopeId);
