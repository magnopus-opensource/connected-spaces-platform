...
enum class StaticModelPropertyKeys : uint16_t
{
    Name_DEPRECATED = 0,
...
private:
    StaticModelSpaceComponent(const schema::ComponentSchema& InSchema, csp::common::LogSystem* LogSystem, SpaceEntity* Parent);
};
