...
public:
    ...
    CSP_NO_EXPORT SpaceEntity(csp::common::IRealtimeEngine* EntitySystem, const ComponentSchemaRegistryImpl& Registry,
...
private:
    ...
    const ComponentSchemaRegistryImpl* SchemaRegistry = nullptr;
