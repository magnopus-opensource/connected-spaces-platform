...
public:
    ...
    /// For hardcoded TypeIds, creates the same concrete type as AddComponent(ComponentType).
    /// For schema-defined TypeIds, creates a ComponentBase backed by the registered schema.
