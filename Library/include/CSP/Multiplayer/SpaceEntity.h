...
public:
    ...
    CSP_NO_EXPORT SpaceEntity(csp::common::IRealtimeEngine* EntitySystem, const ComponentSchemaRegistry& Registry,
...
private:
    ...
    const ComponentSchemaRegistry* SchemaRegistry = nullptr;
