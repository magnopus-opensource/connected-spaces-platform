...
public:
	...
	CSP_NO_EXPORT Array(const Array<T>& Other) : ArraySize(0), ObjectArray(nullptr)
	{
	...
	CSP_NO_EXPORT Array(std::initializer_list<T> List) : ArraySize(0), ObjectArray(nullptr)
	{
		if (List.size() > 0)
		{
