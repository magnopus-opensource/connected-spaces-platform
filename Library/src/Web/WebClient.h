...
public:
	...
	virtual void SetFileUploadContentFromFile(HttpPayload* Payload, const char* FilePath, const char* Version, const csp::common::String& MediaType)
		= 0;
	virtual void SetFileUploadContentFromString(HttpPayload* Payload,
												const csp::common::String& StringSource,
												const csp::common::String& FileName,
												const char* Version,
												const csp::common::String& MediaType)
		= 0;
	virtual void SetFileUploadContentFromBuffer(HttpPayload* Payload,
												const char* Buffer,
												size_t BufferLength,
												const csp::common::String& FileName,
												const char* Version,
...
private:
	...
	void PrintErrorMessages(const HttpResponse& Response);
...
{
public:
	WebClientException(const char* what) : std::runtime_error(what)
	{
	}

	WebClientException(const std::string& what) : std::runtime_error(what)
	{
	}
};
