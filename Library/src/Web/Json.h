...
template <class T> inline csp::common::String TypeToJsonString(const std::shared_ptr<T>& Value)
{
	return Value->ToJson();
}
...
template <> inline rapidjson::Value TypeToJsonValue(const int32_t& Value, RapidJsonAlloc& Allocator)
{
	return rapidjson::Value(Value);
}

template <> inline rapidjson::Value TypeToJsonValue(const uint32_t& Value, RapidJsonAlloc& Allocator)
{
	return rapidjson::Value(Value);
}

template <> inline rapidjson::Value TypeToJsonValue(const int64_t& Value, RapidJsonAlloc& Allocator)
{
	return rapidjson::Value(Value);
}

template <> inline rapidjson::Value TypeToJsonValue(const uint64_t& Value, RapidJsonAlloc& Allocator)
{
	return rapidjson::Value(Value);
}

template <> inline rapidjson::Value TypeToJsonValue(const float& Value, RapidJsonAlloc& Allocator)
{
	return rapidjson::Value(Value);
}

template <> inline rapidjson::Value TypeToJsonValue(const double& Value, RapidJsonAlloc& Allocator)
{
	return rapidjson::Value(Value);
}
...
template <> inline void JsonValueToType(const rapidjson::Value& Value, rapidjson::Document& Type)
{
	Type.CopyFrom(Value, Type.GetAllocator());
}
