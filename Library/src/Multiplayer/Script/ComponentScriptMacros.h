...
#define DEFINE_SCRIPT_PROPERTY_TYPE(COMP, CSPTYPE, SCRIPTTYPE, NAME) \
	...
	{                                                                \
		...
		SendPropertyUpdate();                                        \
                                                                     ...
                                                                     \
	SCRIPTTYPE COMP##ScriptInterface::Get##NAME() const              \
	{                                                                \
		return (SCRIPTTYPE) ((COMP*) Component)->Get##NAME();        \
	}
...
#define DEFINE_SCRIPT_PROPERTY_STRING(COMP, NAME)                            \
	...
	{                                                                        \
		...
		SendPropertyUpdate();                                                \
                                                                             ...
                                                                             \
	std::string COMP##ScriptInterface::Get##NAME() const                     \
	{                                                                        \
		return (std::string)((COMP*) Component)->Get##NAME().c_str();        \
	}
