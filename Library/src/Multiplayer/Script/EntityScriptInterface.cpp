...
EntityScriptInterface::EntityScriptInterface(SpaceEntity* InEntity) : Entity(InEntity)
{
}
...
int64_t EntityScriptInterface::GetId() const
{
	return Entity->GetId();
}
...
void EntityScriptInterface::ClaimScriptOwnership()
{
	Entity->ClaimScriptOwnership();
}
