 ...
 */
#include "ECommerceSpaceComponentScriptInterface.h"
...
DEFINE_SCRIPT_PROPERTY_VEC3(ECommerceSpaceComponent, Position);
DEFINE_SCRIPT_PROPERTY_STRING(ECommerceSpaceComponent, ProductId);
