...
{
public:
	EntitySystemScriptInterface(SpaceEntitySystem* InEntitySystem = nullptr) : EntitySystem(InEntitySystem)
	{
	}
...
EntityScriptBinding::EntityScriptBinding(SpaceEntitySystem* InEntitySystem) : EntitySystem(InEntitySystem)
{
}
...
void BindComponents(qjs::Context::Module* Module)
{
	...
	Module->class_<AnimatedModelSpaceComponentScriptInterface>("AnimatedModelSpaceComponent")
		.constructor<>()
		.base<ComponentScriptInterface>()
		.PROPERTY_GET_SET(AnimatedModelSpaceComponent, ModelAssetId, "modelAssetId")
		.PROPERTY_GET_SET(AnimatedModelSpaceComponent, AssetCollectionId, "assetCollectionId")
	...
	Module->class_<StaticModelSpaceComponentScriptInterface>("StaticModelSpaceComponent")
		.constructor<>()
		.base<ComponentScriptInterface>()
		.PROPERTY_GET_SET(StaticModelSpaceComponent, ModelAssetId, "modelAssetId")
		.PROPERTY_GET_SET(StaticModelSpaceComponent, AssetCollectionId, "assetCollectionId")
