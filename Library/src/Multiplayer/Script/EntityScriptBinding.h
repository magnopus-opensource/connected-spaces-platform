...
public:
    EntityScriptBinding(
        csp::common::IRealtimeEngine* InEntitySystem, const schema::ComponentSchemaRegistry& Registry, csp::common::LogSystem& LogSystem);
    ~EntityScriptBinding();

    void Bind(int64_t ContextId, csp::common::IJSScriptRunner& ScriptRunner) override;

    static EntityScriptBinding* BindEntitySystem(csp::common::IRealtimeEngine* InEntitySystem, const schema::ComponentSchemaRegistry& Registry,
...
private:
    ...
    const schema::ComponentSchemaRegistry& SchemaRegistry;
