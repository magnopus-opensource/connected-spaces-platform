...
constexpr const uint16_t COMPONENT_KEY_VIEW_PREV_ENTITY_ID	   = COMPONENT_KEYS_START_VIEWS + 8;
constexpr const uint16_t COMPONENT_KEY_VIEW_NEXT_ENTITY_ID	   = COMPONENT_KEYS_START_VIEWS + 9;
