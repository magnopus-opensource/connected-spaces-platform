...
Variant::Variant(bool InValue) : ValueType(VariantType::Boolean)
{
	Value.Bool = InValue;
}
...
Variant::Variant(int64_t InValue) : ValueType(VariantType::Integer)
{
	Value.Int = InValue;
}

Variant::Variant(const char* InValue) : ValueType(VariantType::String)
{
	Value.String = InValue;
}

Variant::Variant(const csp::common::String InValue) : ValueType(VariantType::String)
{
	Value.String = InValue;
}

Variant::Variant(Vector3 InValue) : ValueType(VariantType::Vector3)
{
	Value.Vector3 = InValue;
}

Variant::Variant(const Vector4 InValue) : ValueType(VariantType::Vector4)
{
	Value.Vector4 = InValue;
}

Variant::Variant(const Variant& OtherValue)
{
	*this = OtherValue;
}
...
size_t Variant::GetSizeOfInternalValue()
{
	return sizeof(InternalValue);
}

Variant::InternalValue::InternalValue()
{
	memset(this, 0x0, sizeof(InternalValue));
}
