...
public:
	inline StlAllocator() : Allocator {nullptr}
	{
	}

	inline StlAllocator(csp::memory::Allocator* InAllocator) : Allocator {InAllocator}
	{
	}
	...
	template <typename U> inline StlAllocator(StlAllocator<U> const& other) : Allocator {other.Allocator}
	{
	}
