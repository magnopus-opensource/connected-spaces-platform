...
GraphQLSystem::GraphQLSystem() : SystemBase(nullptr, nullptr), GraphQLAPI(nullptr)
{
}

GraphQLSystem::GraphQLSystem(csp::web::WebClient* InWebClient) : SystemBase(InWebClient, nullptr)
{
