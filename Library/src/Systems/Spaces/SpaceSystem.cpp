...
void SpaceSystem::EnterSpace(const String& SpaceId, NullResultCallback Callback)
{
    ...
    SpaceResultCallback GetSpaceCallback = [Callback, SpaceId, this](const SpaceResult& GetSpaceResult) {
        ...
        if (!HasFlag(RefreshedSpace.Attributes, SpaceAttributes::RequiresInvite)) {
            ...
            AddUserToSpace(SpaceId, UserId, [Callback, SpaceId, GetSpaceResult, RefreshedSpace, this](const SpaceResult& Result) {
                ...
                MultiplayerConnection->StopListening(
                    [this, MultiplayerConnection, SpaceId, InternalResult, Callback](csp::multiplayer::ErrorCode Error) {
                        ...
                        MultiplayerConnection->SetScopes(
                            SpaceId, [this, MultiplayerConnection, InternalResult, Callback](csp::multiplayer::ErrorCode Error) {
                                if (Error != csp::multiplayer::ErrorCode::None) {
                                ...
                                MultiplayerConnection->StartListening([this, InternalResult, Callback](csp::multiplayer::ErrorCode Error) {
                                    if (Error != csp::multiplayer::ErrorCode::None) {
            ...
            // Unfortunately we have to stop listening in order for our scope change to take effect, then start again once done.
            // This hopefully will change in a future version when CHS support it.
            MultiplayerConnection->StopListening([this, MultiplayerConnection, SpaceId, InternalResult, Callback](csp::multiplayer::ErrorCode Error) {
                if (Error != csp::multiplayer::ErrorCode::None) {
                ...
                MultiplayerConnection->SetScopes(SpaceId, [this, MultiplayerConnection, InternalResult, Callback](csp::multiplayer::ErrorCode Error) {
                    if (Error != csp::multiplayer::ErrorCode::None) {
                    ...
                    MultiplayerConnection->StartListening([this, MultiplayerConnection, InternalResult, Callback](csp::multiplayer::ErrorCode Error) {
                        if (Error != csp::multiplayer::ErrorCode::None) {
                            CSP_LOG_MSG(csp::systems::LogLevel::Log, " MultiplayerConnection->StartListening fail");
                            CSP_LOG_ERROR_FORMAT(
                                "Error starting listening in order to set scopes, ErrorCode: %s", csp::multiplayer::ErrorCodeToString(Error).c_str());
                            INVOKE_IF_NOT_NULL(Callback, MakeInvalid<NullResult>());
                            return;
                        }
...
void SpaceSystem::ExitSpace(NullResultCallback Callback)
{
    ...
    if (MultiplayerConnection != nullptr) {
        ...
        MultiplayerConnection->StopListening([MultiplayerConnection, Callback](multiplayer::ErrorCode Error) {
            ...
            MultiplayerConnection->ResetScopes([Callback](multiplayer::ErrorCode Error) {
                if (Error != multiplayer::ErrorCode::None) {
                    CSP_LOG_ERROR_FORMAT(
...
void SpaceSystem::AddUserToSpace(const csp::common::String& SpaceId, const String& UserId, SpaceResultCallback Callback)
{
    ...
    GetSpace(SpaceId, [UserId, Callback, this](const SpaceResult& Result) {
        if (Result.GetResultCode() == EResultCode::InProgress) {
            return;
        }
...
{
    AssetCollectionsResultCallback ThumbnailAssetCollCallback
        = [Callback, SpaceId, NewThumbnail, this](const AssetCollectionsResult& AssetCollResult) {
...
void SpaceSystem::AddSpaceThumbnail(const csp::common::String& SpaceId, const FileAssetDataSource& ImageDataSource, NullResultCallback Callback)
{
    ...
    AssetCollectionResultCallback CreateAssetCollCallback = [Callback, AssetSystem, SpaceId, ImageDataSource](
                                                                const AssetCollectionResult& AssetCollResult) {
        if (AssetCollResult.GetResultCode() == EResultCode::InProgress) {
            return;
        }
    ...
    const csp::common::String& SpaceId, const BufferAssetDataSource& ImageDataSource, NullResultCallback Callback)
{
    ...
    AssetCollectionResultCallback CreateAssetCollCallback = [Callback, SpaceId, ImageDataSource, AssetSystem](
                                                                const AssetCollectionResult& AssetCollResult) {
        if (AssetCollResult.GetResultCode() == EResultCode::InProgress) {
            return;
        }
