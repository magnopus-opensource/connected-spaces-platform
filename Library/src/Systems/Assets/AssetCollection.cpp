...
csp::common::Map<csp::common::String, csp::common::String>& AssetCollection::GetMetadataMutable()
{
	return *Metadata;
}

const csp::common::Map<csp::common::String, csp::common::String>& AssetCollection::GetMetadataImmutable() const
{
	return *Metadata;
}

AssetCollection& AssetCollectionResult::GetAssetCollection()
{
	return AssetCollection;
}

const AssetCollection& AssetCollectionResult::GetAssetCollection() const
{
	return AssetCollection;
}
...
const csp::common::Array<AssetCollection>& AssetCollectionsResult::GetAssetCollections() const
{
	return AssetCollections;
}

uint64_t AssetCollectionsResult::GetTotalCount() const
{
