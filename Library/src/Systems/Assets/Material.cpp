...
GLTFMaterial::GLTFMaterial(const csp::common::String& InAssetCollectionId, const csp::common::String& InAssetId)
...
const csp::common::String& GLTFMaterial::GetName() const
{
	return Name;
}
...
const csp::common::String& GLTFMaterial::GetAssetCollectionId() const
{
	return AssetCollectionId;
}

const csp::common::String& GLTFMaterial::GetAssetId() const
{
	return AssetId;
}
