...
PointOfInterestSystem::PointOfInterestSystem() : SystemBase(), POIApiPtr(nullptr)
{
}

PointOfInterestSystem::PointOfInterestSystem(csp::web::WebClient* InWebClient) : SystemBase(InWebClient)
{
