...
PointOfInterestSystem::PointOfInterestSystem() : SystemBase(nullptr, nullptr), POIApiPtr(nullptr)
{
}

PointOfInterestSystem::PointOfInterestSystem(csp::web::WebClient* InWebClient) : SystemBase(InWebClient, nullptr)
{
...
{
	CSP_DELETE(POIApiPtr);
}

CSP_ASYNC_RESULT void PointOfInterestSystem::CreatePOI(const csp::common::String& Title,
													   const csp::common::String& Description,
													   const csp::common::String& Name,
													   const csp::common::Optional<csp::common::Array<csp::common::String>>& Tags,
													   EPointOfInterestType Type,
													   const csp::common::String& Owner,
...
void PointOfInterestSystem::DeleteSite(const Site& Site, NullResultCallback Callback)
{
	DeletePOIInternal(Site.Id, Callback);
}
...
void PointOfInterestSystem::AddSpaceGeoLocation(const csp::common::String& SpaceId,
...
void PointOfInterestSystem::UpdateSpaceGeoLocation(const csp::common::String& SpaceId,
