...
void ProductInfoDtoToProductInfoVariantCollection(const std::vector<chs_aggregation::ShopifyProductDto>& DtoArray,
												  csp::common::Array<ProductInfo>& ProductInfoCollection)
{
