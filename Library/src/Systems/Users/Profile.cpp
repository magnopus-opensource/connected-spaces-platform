...
Profile::Profile() : IsEmailConfirmed(false)
{
}
...
Profile& ProfileResult::GetProfile()
{
	return Profile;
}

const Profile& ProfileResult::GetProfile() const
{
	return Profile;
}
...
csp::common::Array<BasicProfile>& BasicProfilesResult::GetProfiles()
{
	return Profiles;
}

const csp::common::Array<BasicProfile>& BasicProfilesResult::GetProfiles() const
{
	return Profiles;
}
} // namespace csp::systems
