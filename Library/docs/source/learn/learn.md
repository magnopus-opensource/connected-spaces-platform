...
You will learn how spaces are structured, how content relates to them, and gain an addition overview of space scene hierarchies. We will also cover multiplayer architectural design, event handling, and how entities, components, and avatars work together to provide a seamless multi-user experience within a space.
