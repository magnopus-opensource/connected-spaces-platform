...
namespace Csp.Systems
{
    ...
    /// <summary>Data class used to contain information when receiving an array of feature progress.</summary>

    public class FeaturesLimitResult : Csp.Systems.ResultBase, IDisposable
    {
        internal override string _safeTypeName { get; } = "csp_systems_FeaturesLimitResult";
...
#pragma warning disable IDE1006
        ...
        static extern void csp_systems_FeaturesLimitResult_Dtor(IntPtr @class);

#pragma warning restore IDE1006
        #endregion

        internal FeaturesLimitResult(NativePointer ptr) : base(ptr) { }

        public FeaturesLimitResult(Csp.Systems.ResultBase baseInstance)
        ...
        /// <returns>Const array of feature progress class</returns>
        ...
        void RealDispose()
        {
            ...
            {
                csp_systems_FeaturesLimitResult_Dtor(_ptr);
                _disposed = true;
            }
