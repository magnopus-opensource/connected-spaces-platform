...
namespace Csp.Systems
{
    ...
    /// <summary>Result class holding a ticket for an event.</summary>

    public class EventTicketResult : Csp.Systems.ResultBase, IDisposable
    {
        internal override string _safeTypeName { get; } = "csp_systems_EventTicketResult";
...
#pragma warning disable IDE1006
        ...
        static extern void csp_systems_EventTicketResult_Dtor(IntPtr @class);

#pragma warning restore IDE1006
        #endregion

        internal EventTicketResult(NativePointer ptr) : base(ptr) { }

        public EventTicketResult(Csp.Systems.ResultBase baseInstance)
        ...
        void RealDispose()
        {
            ...
            {
                csp_systems_EventTicketResult_Dtor(_ptr);
                _disposed = true;
            }
