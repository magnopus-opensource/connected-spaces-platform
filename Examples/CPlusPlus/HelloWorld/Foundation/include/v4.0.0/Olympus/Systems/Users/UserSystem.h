...
public:
	...
	OLY_ASYNC_RESULT void Login(const oly_common::String& UserName,
								const oly_common::String& Email,
								const oly_common::String& Password,
	...
	OLY_ASYNC_RESULT void GetThirdPartyProviderAuthoriseURL(EThirdPartyAuthenticationProviders AuthProvider,
															const oly_common::String& RedirectURL,
	...
	OLY_ASYNC_RESULT void LoginToThirdPartyAuthenticationProvider(const oly_common::String& ThirdPartyToken,
																  const oly_common::String& ThirdPartyStateId,
																  LoginStateResultCallback Callback);
	...
	OLY_ASYNC_RESULT void CreateUser(const oly_common::Optional<oly_common::String>& UserName,
									 const oly_common::Optional<oly_common::String>& DisplayName,
									 const oly_common::String& Email,
									 const oly_common::String& Password,
									 bool ReceiveNewsletter,
									 const oly_common::Optional<oly_common::String>& RedirectUrl,
									 const oly_common::Optional<oly_common::String>& InviteToken,
	...
	/// @param Password oly_common::String : password associated with the new profile
	/// @param Callback ProfileResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void UpgradeGuestAccount(const oly_common::String& UserName,
											  const oly_common::String& DisplayName,
											  const oly_common::String& Email,
											  const oly_common::String& Password,
											  ProfileResultCallback Callback);
	...
	OLY_ASYNC_RESULT void
		UpdateUserDisplayName(const oly_common::String& UserId, const oly_common::String& NewUserDisplayName, NullResultCallback Callback);
	...
	/// @param Callback NullResultCallback : callback to call when a response is received
	OLY_ASYNC_RESULT void
		ForgotPassword(const oly_common::String& Email, const oly_common::Optional<oly_common::String>& RedirectUrl, NullResultCallback Callback);
...
protected:
	...
	void RefreshAuthenticationSession(const oly_common::String& UserId,
									  const oly_common::String& RefreshToken,
									  const oly_common::String& DeviceId,
