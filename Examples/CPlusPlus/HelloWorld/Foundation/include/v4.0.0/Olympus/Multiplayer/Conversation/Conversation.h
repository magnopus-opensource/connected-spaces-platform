...
private:
	...
	MessageResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
...
private:
	...
	MessageCollectionResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
...
private:
	...
	ConversationResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
