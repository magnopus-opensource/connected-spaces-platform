...
public:
	...
	OLY_ASYNC_RESULT void AddMessageToConversation(const oly_common::String& ConversationId,
												   const oly_common::String& SenderDisplayName,
												   const oly_common::String& Message,
	...
	OLY_ASYNC_RESULT void GetMessagesFromConversation(const oly_common::String& ConversationId,
	...
	/// @param Callback ConversationResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void SetConversationInformation(const oly_common::String& ConversationId,
...
private:
	void StoreConversationMessage(const oly_common::String& ConversationId,
								  const oly_systems::Space& Space,
								  const oly_common::String& UserId,
								  const oly_common::String& SenderDisplayName,
								  const oly_common::String& Message,
