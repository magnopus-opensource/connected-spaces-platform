...
public:
	...
	OLY_ASYNC_RESULT void CreateSpace(const oly_common::String& Name,
									  const oly_common::String& Description,
									  SpaceType Type,
									  ...
									  const oly_common::Optional<oly_systems::FileAssetDataSource>& FileThumbnail,
	...
	/// @param Callback oly_systems::SpaceResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void CreateSpaceWithBuffer(const oly_common::String& Name,
												const oly_common::String& Description,
												SpaceType Type,
												const oly_common::Optional<oly_common::Array<oly_systems::InviteUserRoleInfo>>& InviteUsers,
												const oly_common::Map<oly_common::String, oly_common::String>& Metadata,
												const oly_systems::BufferAssetDataSource& Thumbnail,
												SpaceResultCallback Callback);
	...
	OLY_ASYNC_RESULT void UpdateSpace(const oly_common::String& SpaceId,
									  const oly_common::Optional<oly_common::String>& Name,
									  const oly_common::Optional<oly_common::String>& Description,
									  const oly_common::Optional<oly_systems::SpaceType>& Type,
	...
	OLY_ASYNC_RESULT void GetSpacesByTypes(const oly_common::Array<SpaceType>& RequestedSpaceTypes,
										   const oly_common::Optional<int>& ResultsSkipNumber,
										   const oly_common::Optional<int>& ResultsMaxNumber,
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void InviteToSpace(const oly_common::String& SpaceId,
										const oly_common::String& Email,
										const oly_common::Optional<bool>& IsModeratorRole,
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void
		BulkInviteToSpace(const oly_common::String& SpaceId, const oly_common::Array<InviteUserRoleInfo>& InviteUsers, NullResultCallback Callback);
	...
	OLY_ASYNC_RESULT void GetUsersRoles(const oly_common::String& SpaceId,
										const oly_common::Array<oly_common::String>& RequestedUserIds,
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void UpdateSpaceMetadata(const oly_common::String& SpaceId,
											  const oly_common::Map<oly_common::String, oly_common::String>& NewMetadata,
											  NullResultCallback Callback);
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void
		UpdateSpaceThumbnail(const oly_common::String& SpaceId, const oly_systems::FileAssetDataSource& NewThumbnail, NullResultCallback Callback);
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void UpdateSpaceThumbnailWithBuffer(const oly_common::String& SpaceId,
														 const oly_systems::BufferAssetDataSource& NewThumbnail,
														 NullResultCallback Callback);
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void
		AddUserToSpaceBanList(const oly_common::String& SpaceId, const oly_common::String& RequestedUserId, NullResultCallback Callback);
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void
		DeleteUserFromSpaceBanList(const oly_common::String& SpaceId, const oly_common::String& RequestedUserId, NullResultCallback Callback);
	...
	OLY_ASYNC_RESULT void UpdateSpaceGeoLocation(const oly_common::String& SpaceId,
												 const oly_common::Optional<GeoLocation>& Location,
												 const oly_common::Optional<float>& Orientation,
												 const oly_common::Optional<oly_common::Array<GeoLocation>>& GeoFence,
...
private:
	...
	void AddMetadata(const oly_common::String& SpaceId,
					 const oly_common::Map<oly_common::String, oly_common::String>& Metadata,
					 NullResultCallback Callback);
	...
	void AddSpaceThumbnailWithBuffer(const oly_common::String& SpaceId,
									 const oly_systems::BufferAssetDataSource& ImageDataSource,
									 NullResultCallback Callback);
