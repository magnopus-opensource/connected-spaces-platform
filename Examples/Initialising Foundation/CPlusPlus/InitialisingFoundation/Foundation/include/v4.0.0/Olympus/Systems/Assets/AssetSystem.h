...
public:
	...
	OLY_ASYNC_RESULT void CreateAssetCollection(const oly_common::Optional<oly_common::String>& SpaceId,
												const oly_common::Optional<oly_common::String>& ParentAssetCollectionId,
												const oly_common::String& AssetCollectionName,
												const oly_common::Optional<oly_common::Map<oly_common::String, oly_common::String>>& Metadata,
												const EAssetCollectionType Type,
												const oly_common::Optional<oly_common::Array<oly_common::String>>& Tags,
	...
	/// @param Callback AssetCollectionResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void GetAssetCollectionsByIds(const oly_common::Array<oly_common::String>& AssetCollectionIds,
	...
	OLY_ASYNC_RESULT void GetAssetCollectionsByCriteria(const oly_common::Optional<oly_common::String>& SpaceId,
														...
														const oly_common::Optional<oly_common::Array<oly_common::String>>& AssetCollectionNames,
	...
	OLY_ASYNC_RESULT void CreateAsset(const AssetCollection& AssetCollection,
									  const oly_common::String& Name,
									  const oly_common::Optional<oly_common::String>& ThirdPartyPackagedAssetIdentifier,
									  const oly_common::Optional<oly_systems::EThirdPartyPlatform>& ThirdPartyPlatform,
									  EAssetType Type,
	...
	OLY_ASYNC_RESULT void GetAssetsByCriteria(const oly_common::Array<oly_common::String>& AssetCollectionIds,
											  ...
											  const oly_common::Optional<oly_common::Array<EAssetType>>& AssetTypes,
	...
	OLY_ASYNC_RESULT_WITH_PROGRESS void UploadAssetData(const AssetCollection& AssetCollection,
														const Asset& Asset,
	...
	/// @param Callback UriResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT_WITH_PROGRESS void UploadAssetDataEx(const AssetCollection& AssetCollection,
														  const Asset& Asset,
														  const AssetDataSource& AssetDataSource,
														  oly_common::CancellationToken& CancellationToken,
														  UriResultCallback Callback);
	...
	/// @param Callback AssetResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT_WITH_PROGRESS void
