...
private:
    SpaceResult(void*) {};
    SpaceResult(csp::systems::EResultCode ResCode, uint16_t HttpResCode)
...
private:
    SpacesResult(void*) {};
    SpacesResult(csp::systems::EResultCode ResCode, uint16_t HttpResCode)
        : csp::systems::ResultBase(ResCode, HttpResCode) {};
...
private:
    ...
    SpaceGeoLocationResult(csp::systems::EResultCode ResCode, uint16_t HttpResCode)
        : csp::systems::ResultBase(ResCode, HttpResCode) {};
