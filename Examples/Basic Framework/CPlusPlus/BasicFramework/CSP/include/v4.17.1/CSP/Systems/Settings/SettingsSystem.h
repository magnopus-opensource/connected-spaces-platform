...
public:
	...
	CSP_ASYNC_RESULT void
		AddRecentlyVisitedSpace(const csp::common::String& InUserId, const csp::common::String InSpaceID, NullResultCallback Callback);
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	CSP_ASYNC_RESULT void UpdateAvatarPortrait(const csp::common::String& UserId,
...
private:
	...
	void GetSettingValue(const csp::common::String& InUserId,
						 const csp::common::String& InContext,
						 const csp::common::String& InKey,
