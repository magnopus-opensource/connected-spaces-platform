...
public:
    ...
    CSP_ASYNC_RESULT void CreateSpace(const csp::common::String& Name, const csp::common::String& Description, SpaceAttributes Attributes,
        ...
        const csp::common::Optional<csp::systems::FileAssetDataSource>& FileThumbnail, SpaceResultCallback Callback);
    ...
    /// nullptr.
    /// @param Callback SpacesResultCallback : callback when asynchronous task finishes
    CSP_ASYNC_RESULT void GetSpacesByAttributes(const csp::common::Optional<bool>& IsDiscoverable, const csp::common::Optional<bool>& RequiresInvite,
        const csp::common::Optional<int>& ResultsSkip, const csp::common::Optional<int>& ResultsMax, BasicSpacesResultCallback Callback);
