...
private:
    ...
    MessageResult(csp::systems::EResultCode ResCode, uint16_t HttpResCode)
...
private:
    ...
    MessageCollectionResult(csp::systems::EResultCode ResCode, uint16_t HttpResCode)
        : csp::systems::ResultBase(ResCode, HttpResCode) {};
...
private:
    ...
    ConversationResult(csp::systems::EResultCode ResCode, uint16_t HttpResCode)
        : csp::systems::ResultBase(ResCode, HttpResCode) {};
