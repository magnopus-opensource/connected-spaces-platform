...
public:
	...
	OLY_ASYNC_RESULT void CreateAnchor(oly_systems::AnchorProvider ThirdPartyAnchorProvider,
									   const oly_common::String& ThirdPartyAnchorId,
									   const oly_common::String& AssetCollectionId,
									   const oly_systems::GeoLocation& Location,
									   const oly_systems::OlyAnchorPosition& Position,
	...
	/// @param Tags oly_common::Array<oly_common::String> : optional array of strings to add to the Anchor as tags
	/// @param Callback AnchorResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void CreateAnchorInSpace(oly_systems::AnchorProvider ThirdPartyAnchorProvider,
											  const oly_common::String& ThirdPartyAnchorId,
											  const oly_common::String& SpaceId,
	...
	OLY_ASYNC_RESULT void GetAnchorsInArea(const oly_systems::GeoLocation& OriginLocation,
										   ...
										   const oly_common::Optional<oly_common::Array<oly_common::String>>& Tags,
										   const oly_common::Optional<bool>& AllTags,
										   const oly_common::Optional<oly_common::Array<oly_common::String>>& SpaceIds,
										   const oly_common::Optional<int>& Skip,
										   const oly_common::Optional<int>& Limit,
	...
	/// @param Limit int : optional Maximum number of result entries to be retrieved. for all available result entries pass
	/// @param Callback AnchorCollectionResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void GetAnchorsInSpace(const oly_common::String& SpaceId,
											const oly_common::Optional<int>& Skip,
											const oly_common::Optional<int>& Limit,
											AnchorCollectionResultCallback Callback);
	...
	/// @param Callback AnchorCollectionResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void GetAnchorsByAssetCollectionId(const oly_common::String& AssetCollectionId,
														const oly_common::Optional<int>& Skip,
														const oly_common::Optional<int>& Limit,
														AnchorCollectionResultCallback Callback);
	...
	OLY_ASYNC_RESULT void CreateAnchorResolution(const oly_common::String& AnchorId,
												 bool SuccessfullyResolved,
												 int ResolveAttempted,
												 double ResolveTime,
												 const oly_common::Array<oly_common::String>& Tags,
