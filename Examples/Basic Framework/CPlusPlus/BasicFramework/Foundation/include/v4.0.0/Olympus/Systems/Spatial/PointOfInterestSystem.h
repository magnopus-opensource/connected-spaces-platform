...
public:
	...
	OLY_ASYNC_RESULT void CreatePOI(const oly_common::String& Title,
	...
	OLY_ASYNC_RESULT void
		GetPOIsInArea(const oly_systems::GeoLocation& OriginLocation, const double AreaRadius, POICollectionResultCallback Callback);
	///@}
...
protected:
	...
	void AddSpaceGeoLocation(const oly_common::String& SpaceId,
	...
	void UpdateSpaceGeoLocation(const oly_common::String& SpaceId,
								const oly_common::String& SpaceGeoLocationId,
								const oly_common::Optional<GeoLocation>& Location,
								const oly_common::Optional<float>& Orientation,
								const oly_common::Optional<oly_common::Array<GeoLocation>>& GeoFence,
								SpaceGeoLocationResultCallback Callback);
