...
public:
	...
	OLY_ASYNC_RESULT void
		AddRecentlyVisitedSpace(const oly_common::String& InUserId, const oly_common::String InSpaceID, NullResultCallback Callback);
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void UpdateAvatarPortrait(const oly_common::String& UserId,
											   const oly_systems::FileAssetDataSource& NewAvatarPortrait,
	...
	/// @param Callback NullResultCallback : callback when asynchronous task finishes
	OLY_ASYNC_RESULT void UpdateAvatarPortraitWithBuffer(const oly_common::String& UserId,
														 const oly_systems::BufferAssetDataSource& NewAvatarPortrait,
														 NullResultCallback Callback);
...
private:
	...
	void SetSettingValue(const oly_common::String& InUserId,
						 const oly_common::String& InContext,
						 const oly_common::String& InKey,
						 const oly_common::String& InValue,
						 NullResultCallback Callback) const;
	void GetSettingValue(const oly_common::String& InUserId,
						 const oly_common::String& InContext,
						 const oly_common::String& InKey,
	...
	void AddAvatarPortraitWithBuffer(const oly_common::String& UserId,
