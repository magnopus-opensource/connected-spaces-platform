...
public:
	...
	OLY_ASYNC_RESULT void
		SendNetworkEvent(const oly_common::String& EventName, const oly_common::Array<ReplicatedValue>& Args, CallbackHandler Callback);
	 ...
	 * @param Callback CallbackHandler: A status callback which indicates if the event successfully sent.
	 */
	OLY_ASYNC_RESULT void SendNetworkEventToClient(const oly_common::String& EventName,
												   const oly_common::Array<ReplicatedValue>& Args,
