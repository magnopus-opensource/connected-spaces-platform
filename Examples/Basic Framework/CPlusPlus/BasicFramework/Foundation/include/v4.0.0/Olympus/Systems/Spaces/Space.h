...
private:
	SpaceResult(void*) {};
	SpaceResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
...
private:
	SpacesResult(void*) {};
	SpacesResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
...
private:
	...
	SpaceMetadataResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
	SpaceMetadataResult() {};
...
private:
	...
	SpacesMetadataResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
...
private:
	...
	EnterSpaceResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
	EnterSpaceResult() {};
...
private:
	...
	SpaceGeoLocationResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
...
private:
	...
	SpaceGeoLocationCollectionResult(oly_services::EResultCode ResCode, uint16_t HttpResCode) : oly_services::ResultBase(ResCode, HttpResCode) {};
