...
def upload_test_report(args):
    ...
    # Print the response
    if response.ok:
        print(f"Test results uploaded to https://magnopus.atlassian.net/jira/software/c/projects/{args.project_key}/summary successfully!")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-user_email", required=True, help="The email address of the user uploading test results.")
    parser.add_argument("-api_token", required=True, help="The API token generated by the user uploading test results.")
    
    parser.add_argument("-cycle_name", required=True, help="The name of this test cycle. It should be the unique build name of an OKO client. (e.g. Unity 1.25.1 (5.112.0.0))")
