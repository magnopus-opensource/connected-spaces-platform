...
CSP_PUBLIC_TEST(CSPEngine, ConversationTests, ConversationComponentDeleteTest)
{
    ...
    // Delete the component to internally call DeleteConversation
    {
        ...
        AssetSystem->SetAssetDetailBlobChangedCallback(
            [ConversationId, &CallbackCalled](const csp::multiplayer::AssetDetailBlobChangedNetworkEventData& NetworkEventData)
            {
                EXPECT_EQ(NetworkEventData.ChangeType, csp::multiplayer::EAssetChangeType::Deleted);
...
CSP_PUBLIC_TEST(CSPEngine, ConversationTests, ConversationComponentEventTest)
{
    ...
    {
        csp::multiplayer::ConversationNetworkEventData RetrievedParams;
        bool CallbackCalled = false;

        const auto Callback = [&RetrievedParams, &CallbackCalled](const csp::multiplayer::ConversationNetworkEventData& Params)
        {
...
CSP_PUBLIC_TEST(CSPEngine, ConversationTests, ConversationComponentSecondClientEventDelayTest)
{
    ...
    {
        csp::multiplayer::ConversationNetworkEventData ReceivedParams;
        bool CallbackCalled = false;

        ConversationComponent->SetConversationUpdateCallback(
            [&CallbackCalled, &ReceivedParams, &ReceivedInfo](const csp::multiplayer::ConversationNetworkEventData& Params)
            {
