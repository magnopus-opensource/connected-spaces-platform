...
void GetAssetCollectionCount(csp::systems::AssetSystem* AssetSystem,
							 const csp::common::Optional<csp::common::Array<csp::common::String>>& Ids,
							 const csp::common::Optional<csp::common::String>& ParentId,
...
#if RUN_ALL_UNIT_TESTS || RUN_ASSETSYSTEM_TESTS || RUN_ASSETSYSTEM_GETASSETCOLLECTIONCOUNT_TEST
CSP_PUBLIC_TEST(CSPEngine, AssetSystemTests, GetAssetCollectionCountTest)
{
	...
	// Get Asset collection count associated with their ids
	{
		...
		GetAssetCollectionCount(AssetSystem,
								csp::common::Array<csp::common::String> {AssetCollection1.Id, AssetCollection2.Id, AssetCollection3.Id},
								nullptr,
								nullptr,
								nullptr,
								nullptr,
								csp::common::Array<csp::common::String> {Space.Id},
								Count);
	...
	// Get Asset collection count associated with their names
	{
		...
		GetAssetCollectionCount(
			...
			nullptr,
			nullptr,
			csp::common::Array<csp::common::String> {UniqueAssetCollectionName1, UniqueAssetCollectionName2, UniqueAssetCollectionName3},
			nullptr,
			nullptr,
			csp::common::Array<csp::common::String> {Space.Id},
			Count);
	...
	// Get Asset collection count associated with their type
	{
		...
		GetAssetCollectionCount(AssetSystem,
								...
								nullptr,
								nullptr,
								csp::common::Array<csp::systems::EAssetCollectionType> {csp::systems::EAssetCollectionType::DEFAULT},
								nullptr,
								csp::common::Array<csp::common::String> {Space.Id},
								Count);
	...
	{
		uint64_t Count = 0;
		GetAssetCollectionCount(AssetSystem, nullptr, nullptr, nullptr, nullptr, nullptr, csp::common::Array<csp::common::String> {Space.Id}, Count);
