...
CSP_INTERNAL_TEST(CSPEngine, MaterialUnitTests, GLTFMaterialJsonSerializationTest)
{
    ...
    Emissive.SetStereoVideoType(EStereoVideoType::SideBySide);
    ...
    EXPECT_EQ(DeserializedMaterial.GetBaseColorTexture().GetStereoVideoType(), EStereoVideoType::None);
    ...
    EXPECT_EQ(DeserializedMaterial.GetMetallicRoughnessTexture().GetStereoVideoType(), EStereoVideoType::None);
    ...
    EXPECT_EQ(DeserializedMaterial.GetNormalTexture().GetStereoVideoType(), EStereoVideoType::None);
    ...
    EXPECT_EQ(DeserializedMaterial.GetOcclusionTexture().GetStereoVideoType(), EStereoVideoType::None);
    ...
    EXPECT_EQ(DeserializedMaterial.GetEmissiveTexture().GetStereoVideoType(), EStereoVideoType::SideBySide);
