...
public:
	...
	Awaitable(void (ClassType::*Function)(T0, T1, T2, T3, CallbackType),
			  ClassType* Context,
			  const STRIP(T0) & Arg0,
			  const STRIP(T1) & Arg1,
			  const STRIP(T2) & Arg2,
	...
	Awaitable(void (ClassType::*Function)(T0, T1, T2, T3, T4, CallbackType),
			  ClassType* Context,
			  const STRIP(T0) & Arg0,
			  const STRIP(T1) & Arg1,
			  const STRIP(T2) & Arg2,
	...
	Awaitable(void (ClassType::*Function)(T0, T1, T2, T3, T4, T5, CallbackType),
			  ClassType* Context,
			  const STRIP(T0) & Arg0,
			  const STRIP(T1) & Arg1,
			  const STRIP(T2) & Arg2,
	...
	Awaitable(void (ClassType::*Function)(T0, T1, T2, T3, T4, T5, T6, CallbackType),
			  ClassType* Context,
			  const STRIP(T0) & Arg0,
			  const STRIP(T1) & Arg1,
			  const STRIP(T2) & Arg2,
	...
	Awaitable(void (ClassType::*Function)(T0, T1, T2, T3, T4, T5, T6, T7, CallbackType),
			  ClassType* Context,
			  const STRIP(T0) & Arg0,
			  const STRIP(T1) & Arg1,
			  const STRIP(T2) & Arg2,
	...
	Awaitable(void (ClassType::*Function)(T0, T1, T2, T3, T4, T5, T6, T7, T8, CallbackType),
			  ClassType* Context,
			  const STRIP(T0) & Arg0,
			  const STRIP(T1) & Arg1,
			  const STRIP(T2) & Arg2,
	...
	template <typename ClassType,
			  ...
			  typename T8,
			  typename T9>
	Awaitable(void (ClassType::*Function)(T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, CallbackType),
			  ClassType* Context,
			  const STRIP(T0) & Arg0,
			  const STRIP(T1) & Arg1,
			  const STRIP(T2) & Arg2,
	...
	ResultType Await(std::function<bool(CallbackArgs...)> Predicate = nullptr)
	{
		return Await(DefaultTimeout, Predicate);
	}
