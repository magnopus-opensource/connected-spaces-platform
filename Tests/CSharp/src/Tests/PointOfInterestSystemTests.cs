...
namespace CSPEngine
{
    static class PointOfInterestSystemTests
    {
        ...
        {
            GetFoundationSystems(out var userSystem, out _, out _, out var poiSystem, out _, out _, out _);
        ...
        {
            GetFoundationSystems(out var userSystem, out var spaceSystem, out var assetSystem, out var poiSystem, out _, out _, out _);
