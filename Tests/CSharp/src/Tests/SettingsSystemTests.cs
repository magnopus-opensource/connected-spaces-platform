...
namespace CSPEngine
{
    static class SettingsSystemTests
    {
        ...
        {
            GetFoundationSystems(out var userSystem, out var spaceSystem, out _, out _, out _, out _, out var settingsSystem, out _, out _, out _);
        ...
        {
            GetFoundationSystems(out var userSystem, out var spaceSystem, out var assetSystem, out _, out _, out _, out var settingsSystem, out _, out _, out _);
